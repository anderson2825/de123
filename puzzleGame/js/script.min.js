...
var app = new Vue({
    ...
    methods: {
       playm:function() {
         ...
         playadd:function (index) {
            ...
            this.index_m=(index+todolen)%todolen;
        },
    ...
    mounted: function() {
        ...
        var that=this;
         ...
         this.timem=setInterval(function() {
              var todolen= that.todos.length;
              if(that.$refs.maudio.ended==true){
                if(that.index_m<(todolen-1)){
                    ++that.index_m;
                    that.$refs.maudio.load();
                 }else if(that.index_m>(todolen-1)){
                      --that.index_m;
                      that.$refs.maudio.load();
                 };
                } 
